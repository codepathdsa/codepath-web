...
const REFERRAL_CODE = 'VENKAT-9X2F';
...
const REFERRED_USERS: ReferralEntry[] = [
  { initials: 'AR', color: '#8b5cf6', displayName: 'Arjun R.',    joinedDate: 'Apr 14, 2026', status: 'converted', plan: 'pro',       xpEarned: 250, daysAgo: 1 },
  { initials: 'NK', color: '#3b82f6', displayName: 'Nisha K.',    joinedDate: 'Apr 12, 2026', status: 'converted', plan: 'pro',       xpEarned: 250, daysAgo: 3 },
  { initials: 'RB', color: '#10b981', displayName: 'Rohan B.',    joinedDate: 'Apr 10, 2026', status: 'active',    plan: 'free',      xpEarned: 100, daysAgo: 5 },
  { initials: 'SA', color: '#f97316', displayName: 'Sana A.',     joinedDate: 'Apr 7, 2026',  status: 'converted', plan: 'legendary', xpEarned: 350, daysAgo: 8 },
  { initials: 'TM', color: '#ec4899', displayName: 'Tej M.',      joinedDate: 'Apr 3, 2026',  status: 'active',    plan: 'free',      xpEarned: 100, daysAgo: 12 },
  { initials: 'DL', color: '#06b6d4', displayName: 'Diana L.',    joinedDate: 'Mar 29, 2026', status: 'converted', plan: 'pro',       xpEarned: 250, daysAgo: 17 },
  { initials: 'PG', color: '#ef4444', displayName: 'Pal G.',      joinedDate: 'Mar 20, 2026', status: 'pending',   plan: 'free',      xpEarned: 0,   daysAgo: 26 },
];
...
export default function ReferralPage() {
  ...
  const referralUrl = `${BASE_URL}${REFERRAL_CODE}`;
          ...
          <div className={styles.linkRow}>
            <div className={styles.linkBox}>
              <span className={styles.linkText}>
                {linkType === 'link' ? referralUrl : REFERRAL_CODE}
              </span>
            </div>
            <button
              className={`${styles.copyBtn} ${copied ? styles.copyBtnDone : ''}`}
              onClick={() => handleCopy(linkType === 'link' ? referralUrl : REFERRAL_CODE)}
            >
              {copied ? '✓ Copied' : 'Copy'}
            </button>
          </div>
