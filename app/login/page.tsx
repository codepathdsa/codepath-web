      ...
      <div style={{ width: '100%', maxWidth: 400, background: 'var(--surface)', padding: 40, borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)', boxShadow: 'var(--shadow-lg)' }}>
        ...
        <form style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 8 }}>
            <button formAction={signInOAuth.bind(null, 'github')} style={{ padding: '12px 14px', borderRadius: 'var(--radius)', border: 'none', background: '#181717', color: 'white', fontSize: '0.9rem', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, cursor: 'pointer' }}>
            ...
            <button formAction={signInOAuth.bind(null, 'google')} style={{ padding: '12px 14px', borderRadius: 'var(--radius)', border: 'none', background: '#ea4335', color: 'white', fontSize: '0.9rem', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, cursor: 'pointer' }}>
